...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Dropdown hover — JS 타이머 보강 (CSS gap으로 끊기는 현상 방지)
  document.querySelectorAll('.nav__item').forEach(item => {
    ...
    item.addEventListener('mouseleave', () => {
      leaveTimer = setTimeout(() => item.classList.remove('hover'), 80);
    });
  });
  ...
  <div class="header-inner">
    ...
    <nav class="nav" role="navigation" aria-label="주 메뉴">
      ...
      <div class="nav__item"><a href="${b}quality/index.html" class="nav__link">품질관리</a>
        <div class="nav__dropdown"><a href="${b}quality/index.html">WBP 품질 체계</a><a href="${b}quality/index.html#inspection">검사 항목</a><a href="${b}quality/index.html#storage">보관 · 물류</a></div>
      </div>
  ...
  <div class="footer-inner">
    <div class="footer-top">
      <div class="footer-brand">
        ...
        <p>반도체·디스플레이·자동차 산업을 위한<br>맞춤형 제조 인프라 및 도급화 솔루션</p>
        <div style="margin-top:1.2rem;display:flex;flex-direction:column;gap:.45rem">
          <span style="font-size:.8rem;color:rgba(255,255,255,.35)">Tel. <span style="color:rgba(255,255,255,.55)">[전화번호 입력]</span></span>
          <span style="font-size:.8rem;color:rgba(255,255,255,.35)">Email. <span style="color:rgba(255,255,255,.55)">[이메일 주소 입력]</span></span>
        </div>
      </div>
      <div class="footer-col"><h4>회사소개</h4><ul><li><a href="${b}company/index.html">기업개요</a></li><li><a href="${b}company/index.html#history">연혁</a></li><li><a href="${b}company/index.html#vision">비전 · 로드맵</a><a href="${b}company/index.html#organization">조직 구조</a></li><li><a href="${b}company/location.html">오시는 길</a></li></ul></div>
    ...
    <div class="footer-info"><strong>오디아이 주식회사 (ODI Co., Ltd.)</strong><br>제1공장: 경기도 화성시 양감면 정문송산로 93번길 10-75 &nbsp;|&nbsp; 제2공장: 경기도 화성시 양감면 댕이안길 42-12<br>Tel. [전화번호 입력] &nbsp;|&nbsp; Email. [이메일 주소 입력] &nbsp;|&nbsp; 평일 09:00 – 18:00</div>
